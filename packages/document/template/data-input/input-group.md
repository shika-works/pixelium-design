...
backgroundColor: 背景颜色，详见 [支持的颜色解析](../config/supported-color-parsing)。
shape: 组件形状。
...
backgroundColor: Background color. See [Supported Color Parsing](../config/supported-color-parsing).
