...
<preview path="./popover-place.vue"></preview>
...
<preview path="./popover-trigger.vue"></preview>
...
<preview path="./popover-control.vue"></preview>
...
<preview path="./popover-disabled.vue"></preview>
...
<preview path="./popover-arrow.vue"></preview>
...
<preview path="./popover-offset.vue"></preview>
...
visible: Whether the popover is visible (controlled).
defaultVisible: Whether the popover is visible by default (uncontrolled).
...
slots.content: The popover content.
contentStyle: Style of content area.
]]]