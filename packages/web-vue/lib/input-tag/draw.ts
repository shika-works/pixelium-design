...
type UseDrawOptions = {
	borderRadiusComputed: ComputedRef<InputTagProps['borderRadius']>
	shapeComputed: ComputedRef<InputTagProps['shape']>
	sizeComputed: ComputedRef<InputTagProps['size']>
	disabledComputed: ComputedRef<InputTagProps['disabled']>
	readonlyComputed: ComputedRef<InputTagProps['readonly']>
	statusComputed: ComputedRef<InputTagProps['status']>
	...
	pollSizeChangeComputed: ComputedRef<InputTagProps['pollSizeChange']>
	slots: Slots
}
