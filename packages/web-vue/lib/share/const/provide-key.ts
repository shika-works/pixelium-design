...
export const BASE_DATE_PICKER_PROVIDE = 'px-base-date-picker-provide'
export const TAB_PROVIDE = 'px-tab-provide'
export const COLLAPSE_PROVIDE = 'px-collapse-provide'
export const TIMELINE_PROVIDE = 'px-timeline-provide'
