<template>
	<BaseDatePicker
		...
		v-bind="mergeProps(props, forward, scopedObj, attrs)"
	>
...
import type { DatePickerEvents, DatePickerExpose, DatePickerProps } from './type'
...
defineExpose<DatePickerExpose>(expose)
